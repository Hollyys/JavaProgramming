...
class HttpGetThread extends Thread {
	String urlString;
	ThreadCallbackTest1 caller;
	
	public HttpGetThread(String url, ThreadCallbackTest1 obj) {
		this.urlString = url;
		this.caller = obj;
	}
...
public class ThreadCallbackTest1 {
	String url;
	HttpGetThread httpGetThread;
	
	public ThreadCallbackTest1(String url) {
		this.url = url;
	...
	public static void main(String[] args) {	
		...
		ThreadCallbackTest1 obj = new ThreadCallbackTest1(url);
	}
}
